...
export class TautulliApiService {
  ...
  public async getPaginatedHistory(
    ...
    try {
      ...
      this.logger.log(`Couldn't fetch Tautulli paginated history: ${e.message}`)
      this.logger.debug(e)
      return null
    }
  }
  ...
  public async getChildrenMetadata(
    ...
    try {
      ...
      this.logger.log(`Couldn't fetch Tautulli children metadata: ${e.message}`)
      this.logger.debug(e)
      return null
    }
  }
  ...
  public async testConnection(
    ...
    try {
      ...
      this.logger.warn(`A failure occurred testing Tautulli connectivity: ${e}`)
