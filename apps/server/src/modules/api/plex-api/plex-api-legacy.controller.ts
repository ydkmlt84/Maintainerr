...
export class PlexApiLegacyController {
  ...
  async getCollections(@Param('id') id: string) {
    ...
    if (collections == null) {
      throw new InternalServerErrorException('Could not fetch Plex collections')
    }
    return collections
  }
  ...
  async updateCollection(@Body() body: CreateUpdateCollection) {
    ...
    if (collection == null) {
      throw new InternalServerErrorException('Could not update Plex collection')
    }
    return collection
  }
  ...
  async createCollection(@Body() body: CreateUpdateCollection) {
    ...
    if (collection == null) {
      throw new InternalServerErrorException('Could not create Plex collection')
    }
    return collection
  }
